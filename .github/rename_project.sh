...
original_name="daliuge_component_nifty"
original_urlname="daliuge-component-nifty"
original_description="Awesome daliuge_component_nifty created by ICRAR"
...
mv daliuge_component_nifty $name
