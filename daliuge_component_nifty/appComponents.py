"""
daliuge_component_nifty appComponent module.

This is the module of daliuge_component_nifty containing DALiuGE application components.
...
# @param[in] param/appclass Application Class/daliuge_component_nifty.MyApp/String/readonly/
