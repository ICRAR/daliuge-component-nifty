"""
daliuge_component_nifty component module.

This is the module of daliuge_component_nifty containing DALiuGE data components.
...
# @param[in] param/appclass Drop Class/daliuge_component_nifty.MyData/String/readonly/
